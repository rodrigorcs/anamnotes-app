...
export const NewConversation: FC = () => {
  ...
  return (
    <div className="tw-flex tw-flex-col tw-flex-1">
      <h1 className="tw-text-3xl xs:tw-text-4xl lg:tw-text-5xl tw-font-medium">
      ...
      <h1 className="tw-text-base xs:tw-text-xl lg:tw-text-3xl tw-font-light tw-text-neutrals-400 tw-mt-2 xs:tw-mt-4">
        Pronto para iniciar uma nova <span className="tw-font-normal">anamnese</span>?
      </h1>
      <div className="tw-my-6 xs:tw-my-8 lg:tw-my-12 tw-border-t tw-border-neutrals-100"></div>
        ...
        {[
          ...
          return (
            <div
              ...
              className={cn(
                'tw-flex tw-flex-row tw-py-4 tw-items-center tw-bg-background-100 tw-border tw-border-neutrals-100 tw-rounded-2xl tw-px-4',
            ...
            >
              ...
              <p className="tw-text-neutrals-600 tw-text-sm xs:tw-text-base tw-ml-4 lg:tw-ml-0 lg:tw-mt-8">
                {instruction}
              </p>
            </div>
          )
